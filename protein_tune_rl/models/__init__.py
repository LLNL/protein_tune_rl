...
def create_model(name, hf_config=None, vocab_size=None, train_all_params=False, attn_implementation="eager"):
    ...
    if name.lower() == "iglm":
        ...
        model = AutoModelForCausalLM.from_pretrained(hf_config, attn_implementation=attn_implementation)
